...
function apiGetTitle(title,API_KEY){
    return `https://api.spoonacular.com/recipes/complexSearch?apiKey=${API_KEY}&query=${title}&number=100&addRecipeInformation=true`;
}
function apiGetAll(API_KEY){
    return `https://api.spoonacular.com/recipes/complexSearch?apiKey=${API_KEY}&number=100&addRecipeInformation=true`;
}
